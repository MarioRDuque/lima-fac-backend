...
@Service
@Transactional
public class ProveedorServicioImp extends GenericoServicioImpl<Proveedor, Integer> implements ProveedorServicio {

    private final Logger loggerServicio = LoggerFactory.getLogger(getClass());
    
    @Autowired
    private GenericoDao<Proveedor, Integer> proveedorDao;
    @Autowired
    private GenericoDao<Persona, Integer> personaDao;

    public ProveedorServicioImp(GenericoDao<Proveedor, Integer> genericoHibernate) {
    ...
    public BusquedaPaginada busquedaPaginada(Proveedor entidadBuscar, BusquedaPaginada busquedaPaginada, String numdoc, String nombre, String idubigeo) {
        Criterio filtro;
        filtro = Criterio.forClass(Proveedor.class);
        ...
        busquedaPaginada.setTotalRegistros(proveedorDao.cantidadPorCriteria(filtro, "id"));
        ...
        busquedaPaginada.setRegistros(proveedorDao.buscarPorCriteriaSinProyecciones(filtro));
    ...
    public Proveedor insertar(Proveedor entidad) throws GeneralException{
        ...
        return proveedorDao.insertar(entidad);
    }
    ...
    public ProveedorDTO obtenerProveedor(String id) throws GeneralException {
        ...
        Persona persona = personaDao.obtenerPorCriteriaSinProyecciones(filtro);
        ProveedorDTO o = new ProveedorDTO();
        if(persona!=null){
            o.setDocumento(id);
    ...
    public Proveedor actualizar(Proveedor entidad) throws GeneralException{
        ...
        return proveedorDao.actualizar(entidad);
    }
